...
import com.ins.engage.AppConstants.Companion.POST_DT_PREFIX
import com.ins.engage.AppConstants.Companion.POST_DT_SUFFIX
import com.ins.engage.AppResult
import com.ins.engage.api.RetrofitPostServiceApi
import com.ins.engage.controller.FileDataUtils.Companion.getTokenFromLocal
import com.ins.engage.controller.FileDataUtils.Companion.getUsNameFromLocal
import com.ins.engage.controller.FileDataUtils.Companion.saveTokenIntoLocal
...
//            )
    ...
    private fun getPostDataUrl() = POST_DT_PREFIX + getUsNameFromLocal(context) + POST_DT_SUFFIX
